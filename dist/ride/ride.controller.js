...
let RideController = class RideController {
    ...
    async updateRide(id, updateRideDto) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RideController.prototype, "getRides", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RideController.prototype, "updateRide", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RideController.prototype, "deleteRide", null);
__decorate([
    (0, common_1.Get)('search'),
    __param(0, (0, common_1.Query)('destination')),
    __param(1, (0, common_1.Query)('meetingPoint')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], RideController.prototype, "searchRides", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], RideController.prototype, "getRidesByDriverId", null);
